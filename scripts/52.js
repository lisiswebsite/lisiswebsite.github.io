function initializePlayerBox(numberElementId, resultElementId) {
  ...
  function getOutcome(number) {
    if (number >= 1 && number <= 85) {
      return "Walk";
    } else if (number >= 86 && number <= 244) {
      return "Strikeout";
    } else if (number >= 245 && number <= 269) {
      return "HBP";
    } else if (number >= 270 && number <= 278) {
      return "Reached on error";
    } else if (number >= 279 && number <= 401) {
      return "Flyout";
    } else if (number >= 402 && number <= 519) {
      return "Single";
    } else if (number >= 520 && number <= 642) {
      return "Groundout";
    } else if (number >= 643 && number <= 713) {
      return "Double";
    } else if (number >= 714 && number <= 836) {
      return "Lineout";
    } else if (number >= 837 && number <= 841) {
      return "Triple";
    } else if (number >= 842 && number <= 964) {
      return "Popout";
