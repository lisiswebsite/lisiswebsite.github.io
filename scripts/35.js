function initializePlayerBox(numberElementId, resultElementId) {
  const playerName = "Linzora Shatzman";
  ...
  function getOutcome(number) {
    if (number >= 1 && number <= 125) {
      return "Walk";
    } else if (number >= 126 && number <= 266) {
      return "Strikeout";
    } else if (number >= 267 && number <= 332) {
      return "HBP";
    } else if (number >= 333 && number <= 362) {
      return "Reached on error";
    } else if (number >= 363 && number <= 463) {
      return "Flyout";
    } else if (number >= 464 && number <= 641) {
      return "Single";
    } else if (number >= 642 && number <= 742) {
      return "Groundout";
    } else if (number >= 743 && number <= 770) {
      return "Double";
    } else if (number >= 771 && number <= 871) {
      return "Lineout";
    } else if (number >= 872 && number <= 874) {
      return "Triple";
    } else if (number >= 875 && number <= 975) {
      return "Popout";
    } else if (number >= 976 && number <= 1000) {
      return "Home run";
    }
  }
