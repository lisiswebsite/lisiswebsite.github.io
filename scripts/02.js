function initializePlayerBox(numberElementId, resultElementId) {
  ...
  function getOutcome(number) {
    if (number >= 1 && number <= 121) {
      return "Walk";
    } else if (number >= 122 && number <= 334) {
      return "Strikeout";
    } else if (number >= 335 && number <= 367) {
      return "HBP";
    } else if (number >= 368 && number <= 421) {
      return "Reached on error";
    } else if (number >= 422 && number <= 510) {
      return "Flyout";
    } else if (number >= 511 && number <= 664) {
      return "Single";
    } else if (number >= 665 && number <= 753) {
      return "Groundout";
    } else if (number >= 754 && number <= 782) {
      return "Double";
    } else if (number >= 783 && number <= 871) {
      return "Lineout";
    } else if (number >= 872 && number <= 878) {
      return "Triple";
    } else if (number >= 879 && number <= 967) {
      return "Popout";
