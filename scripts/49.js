function initializePlayerBox(numberElementId, resultElementId) {
  ...
  function getOutcome(number) {
    if (number >= 1 && number <= 110) {
      return "Walk";
    } else if (number >= 111 && number <= 276) {
      return "Strikeout";
    } else if (number >= 277 && number <= 315) {
      return "HBP";
    } else if (number >= 316 && number <= 335) {
      return "Reached on error";
    } else if (number >= 336 && number <= 450) {
      return "Flyout";
    } else if (number >= 451 && number <= 588) {
      return "Single";
    } else if (number >= 589 && number <= 703) {
      return "Groundout";
    } else if (number >= 704 && number <= 753) {
      return "Double";
    } else if (number >= 754 && number <= 868) {
      return "Lineout";
    } else if (number >= 869 && number <= 874) {
      return "Triple";
    } else if (number >= 875 && number <= 989) {
      return "Popout";
