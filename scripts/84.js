function initializePlayerBox(numberElementId, resultElementId) {
  ...
  function getOutcome(number) {
    if (number >= 1 && number <= 104) {
      return "Walk";
    } else if (number >= 105 && number <= 301) {
      return "Strikeout";
    } else if (number >= 302 && number <= 330) {
      return "HBP";
    } else if (number >= 331 && number <= 344) {
      return "Reached on error";
    } else if (number >= 345 && number <= 456) {
      return "Flyout";
    } else if (number >= 457 && number <= 581) {
      return "Single";
    } else if (number >= 582 && number <= 693) {
      return "Groundout";
    } else if (number >= 694 && number <= 738) {
      return "Double";
    } else if (number >= 739 && number <= 850) {
      return "Lineout";
    } else if (number >= 851 && number <= 852) {
      return "Triple";
    } else if (number >= 853 && number <= 964) {
      return "Popout";
    } else if (number >= 965 && number <= 1000) {
      return "Home run";
    }
  }
