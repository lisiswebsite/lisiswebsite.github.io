function initializePlayerBox(numberElementId, resultElementId) {
  ...
  function getOutcome(number) {
    if (number >= 1 && number <= 89) {
      return "Walk";
    } else if (number >= 90 && number <= 159) {
      return "Strikeout";
    } else if (number >= 160 && number <= 190) {
      return "HBP";
    } else if (number >= 191 && number <= 208) {
      return "Reached on error";
    } else if (number >= 209 && number <= 314) {
      return "Flyout";
    } else if (number >= 315 && number <= 585) {
      return "Single";
    } else if (number >= 586 && number <= 691) {
      return "Groundout";
    } else if (number >= 692 && number <= 765) {
      return "Double";
    } else if (number >= 766 && number <= 871) {
      return "Lineout";
    } else if (number >= 872 && number <= 875) {
      return "Triple";
    } else if (number >= 876 && number <= 981) {
      return "Popout";
    } else if (number >= 982 && number <= 1000) {
      return "Home run";
    }
  }
