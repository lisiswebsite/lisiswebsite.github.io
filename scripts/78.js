function initializePlayerBox(numberElementId, resultElementId) {
  ...
  function getOutcome(number) {
    if (number >= 1 && number <= 63) {
      return "Walk";
    } else if (number >= 64 && number <= 316) {
      return "Strikeout";
    } else if (number >= 317 && number <= 349) {
      return "HBP";
    } else if (number >= 350 && number <= 365) {
      return "Reached on error";
    } else if (number >= 366 && number <= 463) {
      return "Flyout";
    } else if (number >= 464 && number <= 629) {
      return "Single";
    } else if (number >= 630 && number <= 727) {
      return "Groundout";
    } else if (number >= 728 && number <= 773) {
      return "Double";
    } else if (number >= 774 && number <= 871) {
      return "Lineout";
    } else if (number >= 872 && number <= 876) {
      return "Triple";
    } else if (number >= 877 && number <= 974) {
      return "Popout";
    } else if (number >= 975 && number <= 1001) {
      return "Home run";
    }
  }
