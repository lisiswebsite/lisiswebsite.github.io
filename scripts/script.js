...
function renderRoster(view) {
    ...
    if (view === 'list') {
        ...
        if (window.innerWidth <= 655) {
            ...
            players.forEach(player => {
                rosterSection.innerHTML += `
                    <a href="players/${player.bioLink}" class="list-player-row-link">
                    ...
                    <tr class="list-player-row">
                        ...
                        <td>
                            <div class="player-right">
                                ...
                                <a href="players/${player.bioLink}" class="player-bio-link">Full Bio</a>
                            </div>
                        </td>
                    </tr>`;
            });
        ...
        players.forEach(player => {
            table += `
                <tr class="grid-player-row">
                    <td>${player.no}</td>
                    <td><a href="players/${player.bioLink}" class="grid-player-name">${player.name}</a></td>
                    <td>${player.pos}</td>
                    <td>${player.year}</td>
                    <td>${player.ht}</td>
        ...
        players.forEach(player => {
            rosterSection.innerHTML += `
                <a href="players/${player.bioLink}" class="player-card-link">
