function initializePlayerBox(numberElementId, resultElementId) {
  ...
  function getOutcome(number) {
    if (number >= 1 && number <= 103) {
      return "Walk";
    } else if (number >= 104 && number <= 275) {
      return "Strikeout";
    } else if (number >= 276 && number <= 312) {
      return "HBP";
    } else if (number >= 313 && number <= 329) {
      return "Reached on error";
    } else if (number >= 330 && number <= 447) {
      return "Flyout";
    } else if (number >= 448 && number <= 585) {
      return "Single";
    } else if (number >= 586 && number <= 703) {
      return "Groundout";
    } else if (number >= 704 && number <= 735) {
      return "Double";
    } else if (number >= 736 && number <= 853) {
      return "Lineout";
    } else if (number >= 854 && number <= 859) {
      return "Triple";
    } else if (number >= 860 && number <= 977) {
      return "Popout";
    } else if (number >= 978 && number <= 1000) {
      return "Home run";
    }
  }
